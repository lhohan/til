...
For details on the automated deployment pipeline, environment variables, GitHub secrets, and local testing, see [`.github/workflows/deployment.md`](.github/workflows/deployment-context.md).
